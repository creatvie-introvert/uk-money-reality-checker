import { buildCalculatorEvidence } from "@/product/calculator/evidence/server";
...
export default function CalculatorLayout({ children }: { children: ReactNode }) {
  return <JourneyProvider evidence={buildCalculatorEvidence()}>{children}</JourneyProvider>;
}
